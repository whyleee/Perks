...
namespace Perks.Data
{
    ...
    /// </summary>
    public class OldLocalFileStorage : IOldFileStorage
    {
        protected readonly IConfigProvider _config;
        protected readonly IoWrapper _io;

        /// <summary>
        /// Initializes a new instance of the <see cref="OldLocalFileStorage" /> class.
        /// </summary>
        public OldLocalFileStorage(IConfigProvider config, IoWrapper io)
        {
